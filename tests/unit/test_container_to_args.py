...
class TestContainerToArgs(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_healthcheck_string(self):
        c = create_compose_mock()
        cnt = get_minimal_container()
        cnt["healthcheck"] = {
            "test": "cmd arg1 arg2",
    ...
    async def test_healthcheck_cmd_args(self):
        c = create_compose_mock()
        cnt = get_minimal_container()
        cnt["healthcheck"] = {
    ...
    async def test_healthcheck_cmd_shell(self):
        c = create_compose_mock()
        cnt = get_minimal_container()
        cnt["healthcheck"] = {
    ...
    async def test_healthcheck_disable(self):
        c = create_compose_mock()
        cnt = get_minimal_container()
        cnt["healthcheck"] = {
            "test": "cmd arg1 arg2",
    ...
    async def test_healthcheck_cmd_shell_error(self):
        c = create_compose_mock()
        cnt = get_minimal_container()
        cnt["healthcheck"] = {
            "test": ["CMD-SHELL", "cmd arg1", "arg2"],
