...
// of both the data availability cost and the operator cost. Before the Isthmus upgrade the operator
// component is zero, so the result is the L1 rollup cost only.
