...
// of both the data availability cost and the operator cost. Before Isthmus activation only the L1
// rollup cost is included; once Isthmus is active the operator rollup cost is added as well.
