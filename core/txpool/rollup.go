...
// RollupCostFunc computes the total rollup cost (L1 data availability cost and operator cost)
// of a transaction at the pool's current head. It returns nil if no rollup cost applies.
...
// the rollup costs (L1 costs and operator costs), and whether the total cost overflowed.
