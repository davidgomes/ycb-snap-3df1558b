...
func (l *list) Add(tx *types.Transaction, priceBump uint64) (bool, *types.Transaction) {
	...
	// Add new tx cost to totalcost. The cost includes the transaction value and
	// every applicable rollup fee (L1 data-availability cost, and the operator
	// fee once Isthmus is active).
