...
def send_webhook(
    ...
    *,
    ...
    try:
        ...
        # 3xx is not an error for raise_for_status; refuse redirects explicitly.
        if getattr(response, "is_redirect", None) is True:
            raise httpx.HTTPStatusError(
                "Redirect responses are not allowed for webhooks.",
